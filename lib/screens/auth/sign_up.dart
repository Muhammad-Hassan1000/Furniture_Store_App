    ...
    if (isValid) {
      ...
      try {
        if(_pickedImage == null){
          ...
          final ref = FirebaseStorage.instance.ref().child('usersImages').child(_fullName + '.jpg');
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        radius: 71,
                        backgroundColor: ColorConsts.gradiendLEnd,
                        child: CircleAvatar(
                          radius: 65,
                          backgroundColor: ColorConsts.gradiendFEnd,
                    ...
                    Positioned(
                        ...
                        child: RawMaterialButton(
                          elevation: 10,
                          fillColor: ColorConsts.gradiendLEnd,
